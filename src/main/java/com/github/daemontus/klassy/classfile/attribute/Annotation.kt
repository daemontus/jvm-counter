...
class Annotation(                       //<1.21.5>
        val typeIndex: Int,             //<1.21.6>
        val numElementValuePairs: Int,  //<1.21.7>
        val pairs: Array<Pair>          //<1.21.8>
) {
    class Pair(                         //<1.21.9>
            val elementNameIndex: Int,  //<1.21.10>
    ...
    sealed class ElementValue(          //<1.21.12>
        ...
        class ConstValue(                   //<1.21.13>
                tag: Byte,                  //<1.21.14>
                val constValueIndex: Int    //<1.21.15>
        ) : ElementValue(tag)

        class EnumValue(                    //<1.21.16>
                tag: Byte,                  //<1.21.17>
                val typeNameIndex: Int,     //<1.21.18>
                val constNameIndex: Int     //<1.21.19>
        ) : ElementValue(tag)

        class ClassValue(                   //<1.21.20>
                tag: Byte,                  //<1.21.21>
                val classInfoIndex: Int     //<1.21.22>
        ) : ElementValue(tag)
