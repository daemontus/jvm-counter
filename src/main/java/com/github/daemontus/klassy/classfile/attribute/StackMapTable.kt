...
class StackMapTable(                    //<1.9.0>
        val attributeNameIndex: Int,    //<1.9.1>
        val attributeLength: Int,       //<1.9.2>
        val numberOfEntries: Int,       //<1.9.3>
    ...
    sealed class Frame(val frameType: Byte) {       //<1.9.52>

        class SameFrame(                            //<1.9.5>
                frameType: Byte                     //<1.9.6>
        ) : Frame(frameType) {

            override fun write(stream: DataOutputStream) = stream.writeByte(frameType.toInt())

        }

        class SameLocalsOneStackItemFrame(          //<1.9.7>
                frameType: Byte,                    //<1.9.8>
                val stack: VerificationType         //<1.9.9>
        ) : Frame(frameType) {

            override fun write(stream: DataOutputStream) = stream.run {
                writeByte(frameType.toInt())
                stack.write(this)
            }
        ...
        class SameLocalsOneStackItemFrameExtended(  //<1.9.10>
                frameType: Byte,                    //<1.9.11>
                val offsetDelta: Int,               //<1.9.12>
        ...
        class ChopFrame(                            //<1.9.14>
                frameType: Byte,                    //<1.9.15>
                val offsetDelta: Int                //<1.9.16>
        ) : Frame(frameType) {
        ...
        class SameFrameExtended(                    //<1.9.17>
                frameType: Byte,                    //<1.9.18>
                val offsetDelta: Int                //<1.9.19>
        ) : Frame(frameType) {
        ...
        class AppendFrame(                          //<1.9.20>
                frameType: Byte,                    //<1.9.21>
                val offsetDelta: Int,               //<1.9.22>
        ...
        class FullFrame(                            //<1.9.24>
                frameType: Byte,                    //<1.9.25>
                val offsetDelta: Int,               //<1.9.26>
                val numberOfLocals: Int,            //<1.9.27>
                val locals: Array<VerificationType>,//<1.9.28>
                val numberOfStackItems: Int,        //<1.9.29>
    ...
    sealed class VerificationType(val tag: Byte) {  //<1.9.51>
        ...
        class Object(               //<1.9.41>
                tag: Byte,          //<1.9.42>
                val constantPoolIndex: Int  //<1.9.43>
        ) : VerificationType(tag)

        class UninitializedVariable(        //<1.9.44>
                tag: Byte,                  //<1.9.45>
                val offset: Int             //<1.9.46>
        ) : VerificationType(tag)
