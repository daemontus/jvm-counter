...
interface ClassFileIO : FieldInfoIO, MethodInfoIO, CpInfoIO, AttributeInfoIO, AttributeIO {


    fun DataInputStream.readClassFile(): ClassFile {
        val magic = readInt()
    ...
    fun DataOutputStream.writeClassFile(file: ClassFile) = file.run {
        writeInt(magic)
