...
internal fun DataInputStream.readAnnotation(): Annotation {
...
internal fun DataInputStream.readAnnotationElementValue(): Annotation.ElementValue {
...
internal fun DataOutputStream.writeAnnotation(annotation: Annotation) = annotation.run {
...
internal fun DataOutputStream.writeAnnotationElementValue(value: Annotation.ElementValue): Unit = value.run {
    writeByte(tag)
    when (this) {
