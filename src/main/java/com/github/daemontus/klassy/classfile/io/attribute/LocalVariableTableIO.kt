...
internal fun AttributeInfo.toLocalVariableTable(): LocalVariableTable = usingStream {
...
internal fun DataOutputStream.writeLocalVariableTable(table: LocalVariableTable) = table.run {
