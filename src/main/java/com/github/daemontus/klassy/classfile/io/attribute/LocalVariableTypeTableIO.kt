...
internal fun AttributeInfo.toLocalVariableTypeTable(): LocalVariableTypeTable = usingStream {
...
internal fun DataOutputStream.writeLocalVariableTypeTable(table: LocalVariableTypeTable) = table.run {
