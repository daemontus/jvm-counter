...
internal fun AttributeInfo.toMethodParameters(): MethodParameters = usingStream {
...
internal fun DataOutputStream.writeMethodParameters(parameters: MethodParameters) = parameters.run {
