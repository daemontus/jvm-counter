...
internal fun AttributeInfo.toRuntimeInvisibleParameterAnnotations(): RuntimeInvisibleParameterAnnotations = usingStream {
...
internal fun DataOutputStream.writeRuntimeInvisibleParameterAnnotations(annotations: RuntimeInvisibleParameterAnnotations) = annotations.run {
