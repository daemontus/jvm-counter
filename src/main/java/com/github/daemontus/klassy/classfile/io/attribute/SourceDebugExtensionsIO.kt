...
internal fun AttributeInfo.toSourceDebugExtensions(): SourceDebugExtensions = usingStream {
...
internal fun DataOutputStream.writeSourceDebugExtensions(extensions: SourceDebugExtensions) = extensions.run {
