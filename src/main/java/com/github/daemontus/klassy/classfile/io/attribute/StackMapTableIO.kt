...
internal fun AttributeInfo.toStackMapTable(): StackMapTable = usingStream {
...
internal fun DataInputStream.readStackMapVerificationType(): StackMapTable.VerificationType {
...
internal fun DataOutputStream.writeStackMapTable(table: StackMapTable) = table.run {
...
internal fun DataOutputStream.writeStackMapVerificationType(type: StackMapTable.VerificationType) = type.run {
    writeByte(tag)
    when(this) {
