...
internal fun DataInputStream.readTypeAnnotation(): TypeAnnotation {
...
internal fun DataInputStream.readTypeAnnotationTarget(): TypeAnnotation.Target {
...
internal fun DataOutputStream.writeTypeAnnotation(annotation: TypeAnnotation) = annotation.run {
...
internal fun DataOutputStream.writeTypeAnnotationTarget(target: TypeAnnotation.Target) = target.run {
